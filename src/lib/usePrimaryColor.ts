...
export const COLOR_PALETTE = [
  ...
  { name: 'amber', label: 'Amber', value: '#f59e0b', foreground: '#ffffff' },
  { name: 'yellow', label: 'Yellow', value: '#eab308', foreground: '#ffffff' },
  { name: 'lime', label: 'Lime', value: '#84cc16', foreground: '#ffffff' },
  ...
  { name: 'cyan', label: 'Cyan', value: '#06b6d4', foreground: '#ffffff' },
